#!/bin/bash
# ============================================================================
# fluent_flutter secrets manager
#
# Manages secrets for whuppi/fluent_flutter ONLY.
...
REPO="whuppi/fluent_flutter"
BWS="${HOME}/bin/bws --color no"
BW_PREFIX="fluent_flutter"
...
case "${1:-}" in
    ...
    rm)     cmd_rm "$2" ;;
    *)
        echo "fluent_flutter secrets manager"
        echo ""
        echo "Usage:"
